...
(function () {
	...
	function closest(el, s) {
		...
		do {
			...
			match =
				(_b =
					(_a = match === null || match === void 0 ? void 0 : match.parentElement) !== null &&
					_a !== void 0
						? _a
	...
	var Aria = /** @class */ (function () {
		...
		Aria.prototype.clear = function (opts) {
			this.items.length = 0;
			if (opts === null || opts === void 0 ? void 0 : opts.emptyContent) this.span.textContent = '';
			return this;
		};
		return Aria;
	})();
			...
			if (controller.KIND_OF_MQ === 'StaticMath') {
				controller.addTextareaEventListeners({
					keydown: function (evt) {
						...
						(_d = (_c = controller.options).overrideKeystroke) === null || _d === void 0
							? void 0
	...
	var Controller_focusBlur = /** @class */ (function (_super) {
		...
		function Controller_focusBlur() {
			...
			_this_1.handleWindowBlur = function () {
				...
				if (_this_1.cursor.selection) _this_1.cursor.selection.domFrag().addClass('mq-blur');
	...
	var VanillaSymbol = /** @class */ (function (_super) {
		...
		function VanillaSymbol(ch, html, mathspeak) {
			return (
				_super.call(this, ch, h('span', {}, [html || h.text(ch)]), undefined, mathspeak) || this
			);
		}
	...
	var TextBlock = /** @class */ (function (_super) {
		...
		TextBlock.prototype.html = function () {
			var out = h('span', { class: 'mq-text-mode' }, [h.text(this.textContents())]);
			this.setDOM(out);
		...
		TextBlock.prototype.mathspeak = function (opts) {
			if (opts && opts.ignoreShorthand) {
				return (
					this.mathspeakTemplate[0] + ', ' + this.textContents() + ', ' + this.mathspeakTemplate[1]
				);
			} else {
				return this.textContents();
			}
    ...
    */
	...
	LatexCmds['\u2207'] = LatexCmds.nabla = LatexCmds.del = bindVanillaSymbol('\\nabla ', '&nabla;');
	...
	function letterSequenceEndingAtNode(node, maxLength) {
		...
		while (node instanceof Letter && node.ctrlSeq === node.letter && i < maxLength) {
			str = node.letter + str;
			node = node[L];
			i += 1;
		}
	...
	var Letter = /** @class */ (function (_super) {
		...
		Letter.prototype.checkAutoCmds = function (cursor) {
			...
			if (maxLength > 0) {
				...
				// sequence of letters
				var str =
					(_c = letterSequenceEndingAtNode(this, maxLength)) !== null && _c !== void 0 ? _c : '';
		...
		Letter.prototype.autoUnItalicize = function (opts) {
			...
			new Fragment(lR || this.parent.getEnd(L), rL || this.parent.getEnd(R)).each(function (el) {
				if (el instanceof Letter) {
					el.italicize(true).domFrag().removeClass('mq-first mq-last mq-followed-by-supsub');
	...
	var NonSymbolaSymbol = /** @class */ (function (_super) {
		...
		function NonSymbolaSymbol(ch, html, _unusedMathspeak) {
			return (
				_super.call(this, ch, h('span', { class: 'mq-nonSymbola' }, [html || h.text(ch)])) || this
			);
		}
	...
	LatexCmds['\u03d6'] = LatexCmds.piv = LatexCmds.varpi = bindVariable('\\varpi ', '&piv;', 'piv'); //W3C/Unicode and Elsevier and 9573-13 //AMS and LaTeX
	LatexCmds['\u03c2'] = // Unicode
	...
	function nodeEndsBinaryOperator(node) {
		return (
			node instanceof BinaryOperator || (node instanceof Letter && node.endsCategory == 'infix')
		);
	}
	...
	var Approx = /** @class */ (function (_super) {
		...
		function Approx() {
			return (
				_super.call(this, '\\approx ', h.entityText('&approx;'), '\u2248', 'approximately equal') ||
				this
			);
		}
				...
				_super.call(
					...
					new DOMView(1, function (blocks) {
						...
						return h.block(tagName, attrs, blocks[0], {
							beforeChild:
								(_c = opts === null || opts === void 0 ? void 0 : opts.beforeChild) === null ||
								_c === void 0
									? void 0
									: _c.call(opts),
							afterChild:
								(_d = opts === null || opts === void 0 ? void 0 : opts.afterChild) === null ||
								_d === void 0
									? void 0
									: _d.call(opts)
						});
	...
	LatexCmds.mathrm = /** @class */ (function (_super) {
		...
		function mathrm() {
			return (
				_super.call(this, '\\mathrm', 'span', { class: 'mq-roman mq-font' }, 'Roman Font', {
			...
			/** @class */ (function (_super) {
				...
				class_12.prototype.createLeftOf = function (cursor) {
					if (!this.replacedFragment) {
						...
						var dontScan = cursor.options.typingSlashCreatesNewFraction && this instanceof Fraction;
						if (!dontScan) {
		...
		Token.prototype.mathspeak = function () {
			...
			this.domFrag()
				...
				.eachElement(function (el) {
					...
					if (typeof label === 'string' && label !== '') ariaLabelArray.push(label);
				});
			return ariaLabelArray.length > 0 ? ariaLabelArray.join(' ').trim() : 'token ' + this.tokenId;
		};
			...
			_this_1.domView = new DOMView(2, function (blocks) {
				return h('span', { class: 'mq-nthroot-container mq-non-leaf' }, [
					...
					h('span', { class: 'mq-scaled mq-sqrt-container' }, [
						h('span', { class: 'mq-sqrt-prefix mq-scaled' }, [SVG_SYMBOLS.sqrt.html()]),
					...
					[
						h(
							'span',
							{
								...
								class: 'mq-scaled mq-bracket-l mq-paren' + (_this_1.side === R ? ' mq-ghost' : '')
							},
							[leftSymbol.html()]
						),
						h.block(
						...
						h(
							'span',
							{
								...
								class: 'mq-scaled mq-bracket-r mq-paren' + (_this_1.side === L ? ' mq-ghost' : '')
							},
							[rightSymbol.html()]
						)
					]
